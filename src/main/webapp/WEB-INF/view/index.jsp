			...
			<div class="col-md-2 ">
				<ul class="list-group">
					<li class="list-group-item  text-center"><a class="channel"
						href="/index/findchannels.do">热门</a></li>
					<c:forEach items="${Channels}" var="channel">
						<li class="list-group-item text-center">
						<a class="channel"
							 href="/index/findchannels.do?chnId=${channel.id}">${channel.name}</a></li>
					</c:forEach>
				</ul>
			</div>
					...
					<div class="card-body">
						<ol>
							<c:forEach items="${lastList}" var="article">
								<li class="text-truncate"><a href="/article/show.do?id=${article.id}">${article.title}</a></li>
							</c:forEach>
						</ol>
					</div>
				</div>
