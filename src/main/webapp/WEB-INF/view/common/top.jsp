...
<nav class="navbar navbar-light bg-light">
  ...
  <ul class="nav">
    ...
    <c:when test="${sessionScope.SESSION_USER_KEY != null}">
		...
		<img alt="" src="/resource/images/default_avata (2).jpg" style="max-height: 2.5rem" class="rounded img-fluid">
   		</a>
   	 </li>
   	 <li class="nav-item">
		  ...
		  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
		     <a class="dropdown-item" href="/index/findchannels.do">返回首页</a>
		    <a class="dropdown-item" href="/user/home.do">个人主页</a>
    ...
    <c:otherwise>
      <%-- 未登录显示登录注册链接 --%>
	   <li class="nav-item"><a class="nav-link" href="/user/toregister.do">注册</a></li>
	   <li class="nav-item"><a class="nav-link" href="/user/tolong.do">登录</a></li>
     </c:otherwise>
    </c:choose>
  </ul>
</nav>